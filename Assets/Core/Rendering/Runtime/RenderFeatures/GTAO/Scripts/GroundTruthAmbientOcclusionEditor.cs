...
namespace UnityEditor.Rendering.Universal
{
    ...
    internal class GroundTruthAmbientOcclusionEditor : Editor
    {
        ...
        {
            public static GUIContent Debug=EditorGUIUtility.TrTextContent("Debug", "Debug to check MultiBounceGTAO");
        ...
        private void Init()
        {
            ...
            m_Debug = settings.FindPropertyRelative("Debug");
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(m_Debug, Styles.Debug);
