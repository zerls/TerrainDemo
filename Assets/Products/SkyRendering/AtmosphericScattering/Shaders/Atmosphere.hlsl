#ifndef  ATMOSPHERE_RAYMARCHING_HLSL
#define  ATMOSPHERE_RAYMARCHING_HLSL
...
AtmosphereParameter GetAtmosphereParameter()
{
    ...
    params.SeaLevel = _SeaLevel;
    params.PlanetRadius = _PlanetRadius;
    params.AtmosphereHeight = _AtmosphereHeight;
    params.SunLightIntensity = _SunLightIntensity;
    params.SunLightColor = _SunLightColor;
    params.SunDiskAngle = _SunDiskAngle;
    params.RayleighScatteringScale = _RayleighScatteringScale;
    params.RayleighScatteringScalarHeight = _RayleighScatteringScalarHeight;
    params.MieScatteringScale = _MieScatteringScale;
    params.MieAnisotropy = _MieAnisotropy;
    params.MieScatteringScalarHeight = _MieScatteringScalarHeight;
    params.OzoneAbsorptionScale = _OzoneAbsorptionScale;
    params.OzoneLevelCenterHeight = _OzoneLevelCenterHeight;
    params.OzoneLevelWidth = _OzoneLevelWidth;
    params.MiePhaseParams = _MiePhaseParams;
    return params;
}
...
float3 IntegralMultiScattering(in AtmosphereParameter param, float3 samplePoint, float3 lightDir, Texture2D transmittanceLut, SamplerState lutSampler)
{
    ...
    const float3 RandomSphereSamples[64] = {
